// components/AnimationList/AnimatedList.jsx
...
const AnimatedList = ({
  ...
  // Fungsi untuk merender item default jika renderItem tidak disediakan
  const renderDefaultItem = (item, index, isSelected) => (
    <div className={`p-4 bg-[#111] rounded-lg ${isSelected ? 'bg-[#222]' : ''} ${itemClassName}`}>
