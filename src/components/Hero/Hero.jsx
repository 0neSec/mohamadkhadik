...
export default function Hero() {
  ...
  const isContactInfoInView = useInView(contactInfoRef, { once: false, amount: 0.3 });
          ...
          >
            <motion.div variants={staggerContainerVariants} className="space-y-6">
              ...
              <div ref={titleRef} className="space-y-4">
                ...
                >
                  Lulusan Sarjana Terapan Teknik Informatika dengan pengalaman dalam pengembangan web menggunakan React.js, Next.js, dan Laravel. Bersemangat menciptakan solusi digital yang inovatif.
                </motion.p>
              </div>
              ...
              >
                ...
                >
                  {[
                    { icon: FaPhone, color: "cyan", label: "Phone", value: "+62 8572 723 58999" },
                    { icon: FaEnvelope, color: "purple", label: "Email", value: "mohamadkhadik7@gmail.com" },
                    { icon: FaMapMarkerAlt, color: "cyan", label: "Location", value: "Brebes, Jawa Tengah" },
                    { icon: FaFire, color: "green", label: "Status", value: "Available for work" }
                  ].map((item, index) => (
                    <motion.div 
                      key={index}
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-white text-sm font-medium relative z-10 hidden sm:inline">LinkedIn</span>
                  </motion.a>
                  ...
                  >
                    ...
                    <span className="text-white text-sm font-medium relative z-10 hidden sm:inline">GitHub</span>
                  </motion.a>
                  ...
                  >
                    ...
                    <span className="text-white font-medium text-sm sm:text-base">Hire Me</span>
                  </motion.button>
                </motion.div>
              </motion.div>
            </motion.div>
