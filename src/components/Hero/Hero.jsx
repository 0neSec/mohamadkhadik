...
export default function Hero() {
  ...
  // Fungsi untuk render teks dengan efek React.js khusus (dengan spasi)
  const renderReactStyleText = (text) => {
    return text.split("").map((char, i) => {
      // Jika karakter adalah spasi, render sebagai &nbsp; (non-breaking space)
      if (char === " ") {
        return (
          <motion.span
            key={i}
            className="react-char inline-block"
            ...
            style={{
              ...
              width: "0.3em", // Memberi lebar yang konsisten untuk spasi
            }}
          >
            &nbsp;
          </motion.span>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 flex-wrap">
                      <motion.div
                        ...
                        className="text-4xl md:text-5xl lg:text-6xl text-cyan-400 shrink-0"
                      >
                        <FaReact />
                      </motion.div>
                      <span className="inline-flex items-baseline flex-wrap text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
                  ...
                  {[
                    ...
                    <motion.div
                      ...
                      whileHover={{
                        x: 5,
                        scale: 1.02,
                        backgroundColor: `rgba(${item.color === "cyan" ? "6, 182, 212" :
                    ...
                    >
                      <motion.div
                        ...
                        className={`p-2 bg-${item.color === "cyan" ? "cyan" :
                            item.color === "purple" ? "purple" :
                              "green"
                          }-500/20 rounded-lg shrink-0`}
                      >
                        <item.icon className={`text-${item.color === "cyan" ? "cyan" :
                            item.color === "purple" ? "purple" :
                              "green"
                          }-400`} />
                      </motion.div>
